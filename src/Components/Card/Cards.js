        ...
        movies.map((obj)=>{
                return(
                                <div className="film-cards">
                                    ...
                                    <button className='playIcon' onClick={()=>getMovie(obj.id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play" viewBox="0 0 16 16">
